...
if (!class_exists('Triply_BA_Booking')) :
    class Triply_BA_Booking {
        ...
        public function widgets() {
            ...
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Allitems_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Wishlist_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_TaxonomiesList_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Taxonomies_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_TaxonomyItem_Widget());

            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new OSF_Elementor_BA_Archive_Booking());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new OSF_Elementor_BA_Archive_Booking_Info());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new OSF_Elementor_BA_Archive_Featured_Image());

            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Searchform_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_PriceFilter_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_RatingFilter_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_SeachResults_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_TaxonomyFilter_Widget());

            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Bookingform_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemrelated_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itempricefrom_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemduration_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemmaxguests_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemminage_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemtourtype_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemstars_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemstars_Criteria_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemslideshow_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemcalendar_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemfaqs_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemcontent_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemothers_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemsteps_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemaddressmap_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_ItemIncluded_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_Itemaddress_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Triply_BABE_Elementor_ItemAdditional_Widget());
        }
